...
<form action="{{route('words')}}" method="GET">
    ...
    <select name="method" id="method">
        <option value="{{ old('name', isset($fields['method']) ? $fields['method']:null)}}" selected>{{ old('name', isset($fields['method']) ? $fields['method']:null)}}</option>
        <option value="words_count">words_count</option>
        <option value="regular_search">regular_search</option>
    </select>
